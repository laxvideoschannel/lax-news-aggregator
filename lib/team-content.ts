...
export const TEAM_PAGE_CONTENT: Record<string, TeamPageContent> = {
  ...
  archers: {
    ...
    roster: [
      { name: 'Tom Schreiber', number: '7', pos: 'A', hometown: 'Huntington, NY', college: 'Princeton', highlight: 'All-time great playmaker', imagePage: 'https://premierlacrosseleague.com/players/tom-schreiber' },
      { name: 'Grant Ament', number: '10', pos: 'A', hometown: 'Doylestown, PA', college: 'Penn State', highlight: 'Elite distributor at X', imagePage: 'https://premierlacrosseleague.com/players/grant-ament' },
      { name: 'Connor Fields', number: '8', pos: 'A', hometown: 'East Amherst, NY', college: 'Albany', highlight: 'Dangerous scorer from every angle', imagePage: 'https://premierlacrosseleague.com/players/connor-fields' },
      { name: 'Brett Dobson', number: '19', pos: 'G', hometown: 'Oshawa, ON', college: 'St. Bonaventure', highlight: 'Reliable presence in cage', imagePage: 'https://premierlacrosseleague.com/players/brett-dobson' },
    ],
    spotlights: [
      { name: 'Tom Schreiber', number: '7', position: 'Attack', hometown: 'Huntington, NY', college: 'Princeton', imagePage: 'https://premierlacrosseleague.com/players/tom-schreiber', description: 'Schreiber remains one of the PLL’s smartest and most complete offensive engines, capable of running an entire game from behind the cage or up top.', quote: 'When the ball moves, everybody becomes dangerous.', stats: [{ label: 'All-Star', value: 'Multi' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Princeton' }, { label: 'Conference', value: 'West' }] },
      { name: 'Grant Ament', number: '10', position: 'Attack', hometown: 'Doylestown, PA', college: 'Penn State', imagePage: 'https://premierlacrosseleague.com/players/grant-ament', description: 'Ament is a pace-setting creator whose vision and feeding ability make the Archers one of the hardest offenses in the league to cover.', quote: 'The more connected we are, the harder we are to guard.', stats: [{ label: 'Role', value: 'Creator' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Penn State' }, { label: 'Conference', value: 'West' }] },
    ],
  },
  outlaws: {
    ...
    roster: [
      { name: 'Lyle Thompson', number: '4', pos: 'A', hometown: 'Onondaga Nation, NY', college: 'Albany', highlight: 'One of the greatest ever', imagePage: 'https://premierlacrosseleague.com/players/lyle-thompson' },
      { name: 'Brennan O’Neill', number: '13', pos: 'A', hometown: 'Bay Shore, NY', college: 'Duke', highlight: 'Power dodger and scorer', imagePage: 'https://premierlacrosseleague.com/players/brennan-oneill' },
      { name: 'Logan McNaney', number: '29', pos: 'G', hometown: 'Coronado, CA', college: 'Maryland', highlight: 'Calm, poised young goalie', imagePage: 'https://premierlacrosseleague.com/players/logan-mcnaney' },
      { name: 'Jared Bernhardt', number: '1', pos: 'M', hometown: 'Longwood, FL', college: 'Maryland', highlight: 'Dynamic athlete in space', imagePage: 'https://premierlacrosseleague.com/players/jared-bernhardt' },
    ],
    spotlights: [
      { name: 'Lyle Thompson', number: '4', position: 'Attack', hometown: 'Onondaga Nation, NY', college: 'Albany', imagePage: 'https://premierlacrosseleague.com/players/lyle-thompson', description: 'Few players in the sport can match Thompson’s creativity, touch, and finishing craft around the crease and from the wing.', quote: 'The game gives back when you play it the right way.', stats: [{ label: 'Legacy', value: 'Elite' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Albany' }, { label: 'Conference', value: 'West' }] },
      { name: 'Brennan O’Neill', number: '13', position: 'Attack', hometown: 'Bay Shore, NY', college: 'Duke', imagePage: 'https://premierlacrosseleague.com/players/brennan-oneill', description: 'O’Neill brings size, range, and downhill force that make him a nightmare matchup when he gets his hands free.', quote: 'I want every dodge to feel like pressure on the defense.', stats: [{ label: 'Style', value: 'Power' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Duke' }, { label: 'Conference', value: 'West' }] },
    ],
  },
  cannons: {
  ...
  whipsnakes: {
    ...
    roster: [
      { name: 'Matt Rambo', number: '1', pos: 'A', hometown: 'Berwyn, PA', college: 'Maryland', highlight: 'One of the fiercest finishers alive', imagePage: 'https://premierlacrosseleague.com/players/matt-rambo' },
      { name: 'Zed Williams', number: '6', pos: 'A', hometown: 'Utica, NY', college: 'Virginia', highlight: 'Power and touch around the crease', imagePage: 'https://premierlacrosseleague.com/players/zed-williams' },
      { name: 'Brad Smith', number: '8', pos: 'M', hometown: 'Oshawa, ON', college: 'Duke', highlight: 'Transition and sixes nightmare', imagePage: 'https://premierlacrosseleague.com/players/brad-smith' },
      { name: 'Joe Nardella', number: '91', pos: 'FO', hometown: 'Cazenovia, NY', college: 'Rutgers', highlight: 'Faceoff tone-setter', imagePage: 'https://premierlacrosseleague.com/players/joe-nardella' },
    ],
    spotlights: [
      { name: 'Matt Rambo', number: '1', position: 'Attack', hometown: 'Berwyn, PA', college: 'Maryland', imagePage: 'https://premierlacrosseleague.com/players/matt-rambo', description: 'Rambo plays with an edge that defines the Whipsnakes, thriving through contact and scoring in the moments when possessions get ugly.', quote: 'You have to love the dirty goals if you want to win in this league.', stats: [{ label: 'Champion', value: 'Multi' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Maryland' }, { label: 'Conference', value: 'East' }] },
      { name: 'Brad Smith', number: '8', position: 'Midfield', hometown: 'Oshawa, ON', college: 'Duke', imagePage: 'https://premierlacrosseleague.com/players/brad-smith', description: 'Smith’s speed, versatility, and two-way motor let Maryland stress defenses before they can get set.', quote: 'If we can run, we can control the game.', stats: [{ label: 'Style', value: 'Two-way' }, { label: 'Position', value: 'Midfield' }, { label: 'College', value: 'Duke' }, { label: 'Conference', value: 'East' }] },
    ],
  },
  atlas: {
    ...
    roster: [
      { name: 'Jeff Teat', number: '17', pos: 'A', hometown: 'Brampton, ON', college: 'Cornell', highlight: 'Premier quarterback of the offense', imagePage: 'https://premierlacrosseleague.com/players/jeff-teat' },
      { name: 'Connor Shellenberger', number: '11', pos: 'A', hometown: 'Charlottesville, VA', college: 'Virginia', highlight: 'Silky creator and passer', imagePage: 'https://premierlacrosseleague.com/players/connor-shellenberger' },
      { name: 'Trevor Baptiste', number: '9', pos: 'FO', hometown: 'Dulles, VA', college: 'Denver', highlight: 'Faceoff dominance changes games', imagePage: 'https://premierlacrosseleague.com/players/trevor-baptiste' },
      { name: 'Jake Carraway', number: '55', pos: 'M', hometown: 'Annapolis, MD', college: 'Georgetown', highlight: 'Stretch shooter and dodger', imagePage: 'https://premierlacrosseleague.com/players/jake-carraway' },
    ],
    spotlights: [
      { name: 'Jeff Teat', number: '17', position: 'Attack', hometown: 'Brampton, ON', college: 'Cornell', imagePage: 'https://premierlacrosseleague.com/players/jeff-teat', description: 'Teat sees the field two passes ahead and punishes late rotations with calm, precise decision-making every possession.', quote: 'Patience creates the windows you are looking for.', stats: [{ label: 'Role', value: 'Quarterback' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Cornell' }, { label: 'Conference', value: 'East' }] },
      { name: 'Connor Shellenberger', number: '11', position: 'Attack', hometown: 'Charlottesville, VA', college: 'Virginia', imagePage: 'https://premierlacrosseleague.com/players/connor-shellenberger', description: 'Shellenberger’s vision and touch give Atlas another elite feeder who can tilt matchups with subtle changes of pace.', quote: 'The best offense is about making the next read easy.', stats: [{ label: 'Role', value: 'Creator' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Virginia' }, { label: 'Conference', value: 'East' }] },
    ],
  },
  waterdogs: {
    ...
    roster: [
      { name: 'Michael Sowers', number: '22', pos: 'A', hometown: 'Upper Dublin, PA', college: 'Duke', highlight: 'Quickest feet in the league', imagePage: 'https://premierlacrosseleague.com/players/michael-sowers' },
      { name: 'Kieran McArdle', number: '15', pos: 'A', hometown: 'Melbourne, AUS', college: 'St. John’s', highlight: 'Savvy veteran scorer', imagePage: 'https://premierlacrosseleague.com/players/kieran-mcardle' },
      { name: 'Trevor Baptiste', number: '5', pos: 'FO', hometown: 'Aurora, CO', college: 'Denver', highlight: 'Faceoff specialist with game control', imagePage: 'https://premierlacrosseleague.com/players/trevor-baptiste' },
      { name: 'Ethan Walker', number: '9', pos: 'A', hometown: 'Peterborough, ON', college: 'Denver', highlight: 'Crafty finisher and feeder', imagePage: 'https://premierlacrosseleague.com/players/ethan-walker' },
    ],
    spotlights: [
      { name: 'Michael Sowers', number: '22', position: 'Attack', hometown: 'Upper Dublin, PA', college: 'Duke', imagePage: 'https://premierlacrosseleague.com/players/michael-sowers', description: 'Sowers wins with pace, body control, and the ability to put defenders on skates in tight spaces.', quote: 'If I can get the defense shifting, everything opens up.', stats: [{ label: 'Role', value: 'Dodger' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Duke' }, { label: 'Conference', value: 'East' }] },
      { name: 'Kieran McArdle', number: '15', position: 'Attack', hometown: 'Melbourne, AUS', college: 'St. John’s', imagePage: 'https://premierlacrosseleague.com/players/kieran-mcardle', description: 'McArdle remains a polished finisher whose feel around the crease gives Philadelphia a steady scoring floor.', quote: 'The best finishers stay calm when the game speeds up.', stats: [{ label: 'Role', value: 'Finisher' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'St. John’s' }, { label: 'Conference', value: 'East' }] },
    ],
  },
  redwoods: {
    ...
    roster: [
      { name: 'Ryder Garnsey', number: '13', pos: 'A', hometown: 'Denver, CO', college: 'Notre Dame', highlight: 'Creative finisher and feeder', imagePage: 'https://premierlacrosseleague.com/players/ryder-garnsey' },
      { name: 'Jules Heningburg', number: '10', pos: 'M', hometown: 'West Nyack, NY', college: 'Rutgers', highlight: 'Strong, downhill dodger', imagePage: 'https://premierlacrosseleague.com/players/jules-heningburg' },
      { name: 'TD Ierlan', number: '55', pos: 'FO', hometown: 'Victor, NY', college: 'Denver', highlight: 'Faceoff and possession machine', imagePage: 'https://premierlacrosseleague.com/players/td-ierlan' },
      { name: 'Myles Jones', number: '3', pos: 'M', hometown: 'Huntington, NY', college: 'Duke', highlight: 'Explosive dodging midfielder', imagePage: 'https://premierlacrosseleague.com/players/myles-jones' },
    ],
    spotlights: [
      { name: 'Ryder Garnsey', number: '13', position: 'Attack', hometown: 'Denver, CO', college: 'Notre Dame', imagePage: 'https://premierlacrosseleague.com/players/ryder-garnsey', description: 'Garnsey’s imagination and release variety make him a dangerous finisher from bad angles and broken plays.', quote: 'Sometimes the best attack move is the one no one expects.', stats: [{ label: 'Role', value: 'Creator' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Notre Dame' }, { label: 'Conference', value: 'West' }] },
      { name: 'TD Ierlan', number: '55', position: 'Faceoff', hometown: 'Victor, NY', college: 'Denver', imagePage: 'https://premierlacrosseleague.com/players/td-ierlan', description: 'Ierlan changes the game before it starts, giving the Redwoods extra possessions and dictating rhythm from the stripe.', quote: 'Possession is a weapon if you stay consistent.', stats: [{ label: 'Role', value: 'Faceoff' }, { label: 'Position', value: 'FO' }, { label: 'College', value: 'Denver' }, { label: 'Conference', value: 'West' }] },
    ],
  },
