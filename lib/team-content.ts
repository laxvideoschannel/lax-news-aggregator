...
export const TEAM_PAGE_CONTENT: Record<string, TeamPageContent> = {
  ...
  outlaws: {
    ...
    spotlights: [
      { name: 'Lyle Thompson', number: '4', position: 'Attack', hometown: 'Onondaga Nation, NY', college: 'Albany', imagePage: 'https://premierlacrosseleague.com/articles/denver-outlaws-2026-championship-series', description: 'Few players in the sport can match Thompson’s creativity, touch, and finishing craft around the crease and from the wing.', quote: 'The game gives back when you play it the right way.', stats: [{ label: 'Legacy', value: 'Elite' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Albany' }, { label: 'Conference', value: 'West' }] },
      { name: 'Brennan O’Neill', number: '13', position: 'Attack', hometown: 'Bay Shore, NY', college: 'Duke', imagePage: 'https://premierlacrosseleague.com/articles/denver-outlaws-2026-championship-series', description: 'O’Neill brings size, range, and downhill force that make him a nightmare matchup when he gets his hands free.', quote: 'I want every dodge to feel like pressure on the defense.', stats: [{ label: 'Style', value: 'Power' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Duke' }, { label: 'Conference', value: 'West' }] },
    ],
  },
  cannons: {
  ...
  whipsnakes: {
    ...
    spotlights: [
      { name: 'Matt Rambo', number: '1', position: 'Attack', hometown: 'Berwyn, PA', college: 'Maryland', imagePage: 'https://premierlacrosseleague.com/articles/maryland-whipsnakes-2026-championship-series', description: 'Rambo plays with an edge that defines the Whipsnakes, thriving through contact and scoring in the moments when possessions get ugly.', quote: 'You have to love the dirty goals if you want to win in this league.', stats: [{ label: 'Champion', value: 'Multi' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Maryland' }, { label: 'Conference', value: 'East' }] },
      { name: 'Brad Smith', number: '8', position: 'Midfield', hometown: 'Oshawa, ON', college: 'Duke', imagePage: 'https://premierlacrosseleague.com/articles/maryland-whipsnakes-2026-championship-series', description: 'Smith’s speed, versatility, and two-way motor let Maryland stress defenses before they can get set.', quote: 'If we can run, we can control the game.', stats: [{ label: 'Style', value: 'Two-way' }, { label: 'Position', value: 'Midfield' }, { label: 'College', value: 'Duke' }, { label: 'Conference', value: 'East' }] },
    ],
  },
  atlas: {
    ...
    spotlights: [
      { name: 'Jeff Teat', number: '17', position: 'Attack', hometown: 'Brampton, ON', college: 'Cornell', imagePage: 'https://premierlacrosseleague.com/articles/new-york-atlas-2026-championship-series', description: 'Teat sees the field two passes ahead and punishes late rotations with calm, precise decision-making every possession.', quote: 'Patience creates the windows you are looking for.', stats: [{ label: 'Role', value: 'Quarterback' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Cornell' }, { label: 'Conference', value: 'East' }] },
      { name: 'Connor Shellenberger', number: '11', position: 'Attack', hometown: 'Charlottesville, VA', college: 'Virginia', imagePage: 'https://premierlacrosseleague.com/articles/new-york-atlas-2026-championship-series', description: 'Shellenberger’s vision and touch give Atlas another elite feeder who can tilt matchups with subtle changes of pace.', quote: 'The best offense is about making the next read easy.', stats: [{ label: 'Role', value: 'Creator' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Virginia' }, { label: 'Conference', value: 'East' }] },
    ],
  },
  waterdogs: {
    ...
    spotlights: [
      { name: 'Michael Sowers', number: '22', position: 'Attack', hometown: 'Upper Dublin, PA', college: 'Duke', imagePage: 'https://premierlacrosseleague.com/articles/philadelphia-waterdogs-2026-championship-series', description: 'Sowers wins with pace, body control, and the ability to put defenders on skates in tight spaces.', quote: 'If I can get the defense shifting, everything opens up.', stats: [{ label: 'Role', value: 'Dodger' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Duke' }, { label: 'Conference', value: 'East' }] },
      { name: 'Kieran McArdle', number: '15', position: 'Attack', hometown: 'Melbourne, AUS', college: 'St. John’s', imagePage: 'https://premierlacrosseleague.com/articles/philadelphia-waterdogs-2026-championship-series', description: 'McArdle remains a polished finisher whose feel around the crease gives Philadelphia a steady scoring floor.', quote: 'The best finishers stay calm when the game speeds up.', stats: [{ label: 'Role', value: 'Finisher' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'St. John’s' }, { label: 'Conference', value: 'East' }] },
    ],
  },
  redwoods: {
    ...
    spotlights: [
      { name: 'Ryder Garnsey', number: '13', position: 'Attack', hometown: 'Denver, CO', college: 'Notre Dame', imagePage: 'https://premierlacrosseleague.com/articles/california-redwoods-2026-championship-series', description: 'Garnsey’s imagination and release variety make him a dangerous finisher from bad angles and broken plays.', quote: 'Sometimes the best attack move is the one no one expects.', stats: [{ label: 'Role', value: 'Creator' }, { label: 'Position', value: 'Attack' }, { label: 'College', value: 'Notre Dame' }, { label: 'Conference', value: 'West' }] },
      { name: 'TD Ierlan', number: '55', position: 'Faceoff', hometown: 'Victor, NY', college: 'Denver', imagePage: 'https://premierlacrosseleague.com/articles/california-redwoods-2026-championship-series', description: 'Ierlan changes the game before it starts, giving the Redwoods extra possessions and dictating rhythm from the stripe.', quote: 'Possession is a weapon if you stay consistent.', stats: [{ label: 'Role', value: 'Faceoff' }, { label: 'Position', value: 'FO' }, { label: 'College', value: 'Denver' }, { label: 'Conference', value: 'West' }] },
    ],
  },
